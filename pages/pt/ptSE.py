    ...
    return html.Div(
        [
            ...
            [
                ...
                html.Div(
                [
                    html.H6('Método',style={'display':'inline-block','margin-right':20}),
                    dcc.Dropdown(
                    [
                        {
                            "label": html.Span(['Completo'], style={'color': '0f29ce', 'font-size': 15}),
                            "value": 'padrao',
                        },
                        {
                            "label": html.Span(['Desac Rápido Algoritmo'], style={'color': '0f29ce', 'font-size': 15}),
                            "value": 'algoritmo',
                        },
                        {
                            "label": html.Span(['Desac Rápido Modelo'], style={'color': '0f29ce', 'font-size': 15}),
                            "value": 'modelo',
                        },
                    ], value='padrao', id='select-ee'
                    )
                ],style={"width": "50%",'margin-bottom': '20px', 'margin-top': '30px'},
                ),
                ...
                html.Div(
                [
                    html.Button('Exportar Relatório da Estimação', id='exe-EE-step', n_clicks=0, style = {'color':'#FFFFF8' , 'background-color' : '#98151b'},), 
                ...
                [
                    ...
                    [
                        ...
                        dash_table.DataTable(   id = 'criticalities',
                                                ...
                                                style_table={'height': '300px', 'width': '350px', 'overflowY': 'auto'},
                                                style_cell={'textAlign': 'center'},
                    ...
                    [
                        ...
                        style_table={'height': '300px','overflow': 'auto', 'align':'left'},style_cell={'textAlign': 'center'}),
                    ], 
                    className="six columns", 
