    ...
    return html.Div(
        [
            ...
            html.Div(
                ...
                html.Div(
                [
                    html.H6('Method',style={'display':'inline-block','margin-right':20}),
                    dcc.Dropdown(
                    [
                        {
                            "label": html.Span(['Complete'], style={'color': '0f29ce', 'font-size': 15}),
                            "value": "padrao",
                        },
                        {
                            "label": html.Span(['Algorithm Decoupled'], style={'color': '0f29ce', 'font-size': 15}),
                            "value": "algoritmo",
                        },
                        {
                            "label": html.Span(['Model Decoupled'], style={'color': '0f29ce', 'font-size': 15}),
                            "value": "modelo",
                        },
                ...
                html.H6('Iterations\' Limit',style={'display':'inline-block','margin-right':20}),
                html.Div(
                    [
                        dcc.Input(
                            id="input_iteracoes",
